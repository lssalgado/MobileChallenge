...
mockedJson = [{"name": "batata", "image": "asdasd", "price": "0", u"preço": "0"},
              {"name": "batata", "image": "asdasd",
                  "price": "1", u"preço": "3.50"},
              {"name": "batata", "image": "asdasd",
                  "price": "2.55", u"preço": "8.92"},
              {"name": "batata", "image": "asdasd", "price": "10", u"preço": "35"},
              {"name": "batata", "image": "asdasd", "price": "10", u"preço": "35"}, ]

wrongJson = [{"name": 1, "image": "asdasd", "price": "0", u"preço": "0"}, {"name": "batata", "image": 1, "price": "0", u"preço": "0"}]
...
class TestDetailer(unittest.TestCase):
    ...
    def test_buildString_fail(self):
        self.assertRaises(TypeError, buildString(wrongJson,1))
